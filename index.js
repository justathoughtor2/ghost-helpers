...
GhostHelpers = App.extend({
  ...
  activate: function() {
    this.ghost.helpers.register('blog-header-bg', this.handleBlogHeaderBg(image, options));
    this.ghost.helpers.register('post-loop-bg', this.handlePostLoopBg(image, index, options));
  },
